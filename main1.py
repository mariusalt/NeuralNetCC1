...
for i in range(20):
    for lay in range(1, 5):
        ...
        def_para = ['none', default_parameters1, default_parameters2, default_parameters3, default_parameters4,
                    default_parameters5]

        if lay == 4:
            def create_model(learning_rate, activation, regularization1, regularization2, noise, num_dense_nodes1,
                             num_dense_nodes2,
                ...
                for i in range(lay):
                    ...
                    model.add(Dense(l1[i],
                                    ...
                                    name=name,
                                    kernel_regularizer=regularizers.l1_l2(l1=regularization1, l2=regularization2)))
            ...
            def fitness(learning_rate, activation, regularization1, regularization2, noise, num_dense_nodes1,
                        num_dense_nodes2, num_dense_nodes3,
                        num_dense_nodes4,
                        num_dropouts1, num_dropouts2, num_dropouts3, num_dropouts4
                        , num_batch_size):
                ...
                if accuracy > best_accuracy:
                    ...
                    out.append(
                        [learning_rate, num_dense_nodes1, lay, activation, regularization1, regularization2, noise,
                         num_dense_nodes2,
                         num_dense_nodes3,
                         num_dense_nodes4,
                         num_dropouts1, num_dropouts2, num_dropouts3, num_dropouts4,
            ...
            def create_model(learning_rate, activation, regularization1, regularization2, noise, num_dense_nodes1,
                             num_dropouts1, num_dense_nodes2,
                             num_dropouts2):
                model = Sequential()
            ...
            @use_named_args(dimensions=dimensions)
            def fitness(learning_rate, activation, regularization1, regularization2, noise, num_batch_size,
                        num_dense_nodes1, num_dropouts1,
...
with open('/home/mat/Desktop/cond_coop/trials/main12/20210504_sesca3_l1_l2.csv', "w", newline="") as f:
    writer = csv.writer(f)
    for i in out:
        writer.writerow(i)
